 ...
 */
export class ClaudeOpusAdapter {
    name = 'Claude Opus';
    backend = 'claude-opus';
    process;
    running = false;
     ...
     */
    buildPrompt(sessionId, systemPrompt) {
        return `${systemPrompt}
...
Begin watching now. Stay quiet unless you spot a real issue.`;
    ...
    async spawn(sessionId, systemPrompt) {
     ...
     */
    getTaskPrompt(sessionId, systemPrompt) {
        return {
...
//# sourceMappingURL=claude-opus.js.map